...
export class InitializeSchema1637696961996 implements MigrationInterface {
    name = 'InitializeSchema1637696961996'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "transaction" ("id" SERIAL NOT NULL, "date" date NOT NULL, "description" text NOT NULL, "amount" numeric(12,2) NOT NULL, "balance" numeric(12,2) NOT NULL, "balanceCorrection" numeric(12,2) NOT NULL DEFAULT '0', "uploadId" integer, "tagId" integer, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`);

...
export class CreateDatabase1606145610078 implements MigrationInterface {
    name = 'CreateDatabase1606145610078'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "transaction" ("id" SERIAL NOT NULL, "date" date NOT NULL, "description" text NOT NULL, "amount" double precision NOT NULL, "balance" double precision NOT NULL, "balanceCorrection" double precision NOT NULL DEFAULT 0, "uploadId" integer, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "account" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "dateHeader" character varying NOT NULL, "descriptionHeader" character varying NOT NULL, "amountHeader" character varying NOT NULL, "startingAmount" double precision NOT NULL DEFAULT 0, "balance" double precision NOT NULL DEFAULT 0, "amountsInverted" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_414d4052f22837655ff312168cb" UNIQUE ("name"), CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`);

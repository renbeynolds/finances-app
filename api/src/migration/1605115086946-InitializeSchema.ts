...
export class InitializeSchema1605115086946 implements MigrationInterface {
    name = 'InitializeSchema1605115086946'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "account_settings" ("id" SERIAL NOT NULL, "dateHeader" character varying NOT NULL, "descriptionHeader" character varying NOT NULL, "amountHeader" character varying NOT NULL, "amountsInverted" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_cede89a31d2392a1064087af67a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "transaction" ("id" SERIAL NOT NULL, "date" date NOT NULL, "description" text NOT NULL, "amount" double precision NOT NULL, "uploadId" integer, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "account" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "settingsId" integer, CONSTRAINT "UQ_414d4052f22837655ff312168cb" UNIQUE ("name"), CONSTRAINT "REL_952cc5aa4f520ea3681744033b" UNIQUE ("settingsId"), CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "account" ADD CONSTRAINT "FK_952cc5aa4f520ea3681744033b7" FOREIGN KEY ("settingsId") REFERENCES "account_settings"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "account" DROP CONSTRAINT "FK_952cc5aa4f520ea3681744033b7"`);
